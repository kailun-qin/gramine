...
encrypted data and are linked to MHT nodes. Allocation of the file nodes can be
...
file nodes, Gramine provides an optional free list of pre-allocated nodes as an
...
via the manifest option ``fs.limits.encrypted_files_node_free_list``. See
